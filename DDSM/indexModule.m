...
for i=1:numROIs
    ...
    %[r1,r2, c1, c2] = findCentroid(boundingBoxes(i,:),numRows,numCols);
    r1 = boundingBoxes(i,1);
    r2 = boundingBoxes(i,2);
    c1 = boundingBoxes(i,3);
    c2 = boundingBoxes(i,4);
    %[r1, r2, c1,c2 ] = boundingBoxes(i,:);
